...
-(void)show:(BOOL)show{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        if(!isOpen){
            ...
            //获取CustomViewController,同时设置导航栏隐藏-add by liuhj 20150609
            CustomViewController *vc = (CustomViewController *)[self viewController];
            [vc setNavBarHidden:!isOpen];
...
//获取sideview的CustomViewController-add by liuhj 20150609
